...
이를 유명 셰프에게 배우는 상황으로 보면 차이가 선명해진다. 주방 안에서 조리 과정을 전부 볼 수 있다면 white-box에 가깝고, 완성된 요리를 맛본 뒤 레시피를 추론하며 배우는 것은 black-box에 가깝다. LLM distillation도 비슷하다. teacher의 내부를 볼 수 있느냐 없느냐에 따라 접근 방식이 달라진다.
